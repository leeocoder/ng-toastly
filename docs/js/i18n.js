...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    'en': {
      ...
      // ng-add Schematic Section
      'ngadd.title': 'Automatic Setup with ng add',
      'ngadd.intro': 'The fastest way to add ng-toastly to your project.',
      'ngadd.what.title': 'What is ng add?',
      'ngadd.what.p1': '<code>ng add</code> is an official Angular CLI command that allows libraries to automatically configure your project. Instead of manually editing files, the library does it for you — safely and correctly.',
      'ngadd.what.p2': 'ng-toastly uses this feature to save you time and prevent common setup mistakes.',
      'ngadd.how.title': 'How to Use',
      'ngadd.how.command': 'Simply run this command in your Angular project:',
      'ngadd.how.safe': '✅ <strong>Safe to run:</strong> This command only adds what\'s needed. It won\'t break your project.',
      'ngadd.how.once': '✅ <strong>Run once:</strong> If you run it again, it will skip what\'s already configured.',
      'ngadd.configures.title': 'What Gets Configured',
      'ngadd.configures.intro': 'The schematic automatically:',
      'ngadd.configures.item1': '✅ Adds <code>provideToastly()</code> to your app configuration',
      'ngadd.configures.item2': '✅ Adds <code>&lt;toastly-container /&gt;</code> to your AppComponent',
      'ngadd.configures.item3': '✅ Detects if your project uses standalone components or NgModule',
      'ngadd.configures.item4': '✅ Avoids duplicating code if already configured',
      'ngadd.configures.item5': '✅ Shows clear messages about what was changed',
      'ngadd.notdo.title': 'What It Does NOT Do',
      'ngadd.notdo.intro': 'By design, the schematic does not:',
      'ngadd.notdo.item1': '❌ Set a specific theme (light/dark)',
      'ngadd.notdo.item2': '❌ Configure language or i18n',
      'ngadd.notdo.item3': '❌ Modify your app\'s styles or layout',
      'ngadd.notdo.item4': '❌ Add unnecessary dependencies',
      'ngadd.notdo.why': '<strong>Why?</strong> These decisions belong to your application, not to the library. ng-toastly respects your code and only adds the minimum required configuration.',
      'ngadd.why.title': 'Why Use a Schematic?',
      'ngadd.why.item1': '<strong>Reduces setup time</strong> — No manual file editing required',
      'ngadd.why.item2': '<strong>Prevents mistakes</strong> — Correct configuration every time',
      'ngadd.why.item3': '<strong>Improves DX</strong> — Better developer experience from the start',
      'ngadd.why.item4': '<strong>Keeps code clean</strong> — Adds only what\'s necessary',
      'ngadd.safe.title': 'Safety & Best Practices',
      'ngadd.safe.item1': '🔒 <strong>Idempotent:</strong> Running twice won\'t duplicate anything',
      'ngadd.safe.item2': '🔍 <strong>Respects structure:</strong> Works with your existing project setup',
      'ngadd.safe.item3': '📝 <strong>Clear feedback:</strong> Terminal messages explain what was changed',
      'ngadd.options.title': 'Available Options',
      'ngadd.options.intro': 'You can customize the schematic with options:',
      'ngadd.options.position': 'Set default toast position',
      'ngadd.options.skipContainer': 'Skip adding the container component',
    ...
    'pt-br': {
      ...
      // ng-add Schematic Section
      'ngadd.title': 'Configuração Automática com ng add',
      'ngadd.intro': 'A forma mais rápida de adicionar ng-toastly ao seu projeto.',
      'ngadd.what.title': 'O que é ng add?',
      'ngadd.what.p1': '<code>ng add</code> é um comando oficial do Angular CLI que permite que bibliotecas configurem seu projeto automaticamente. Em vez de editar arquivos manualmente, a biblioteca faz isso por você — de forma segura e correta.',
      'ngadd.what.p2': 'ng-toastly usa esse recurso para economizar seu tempo e evitar erros comuns de configuração.',
      'ngadd.how.title': 'Como Usar',
      'ngadd.how.command': 'Basta executar este comando no seu projeto Angular:',
      'ngadd.how.safe': '✅ <strong>Seguro:</strong> Este comando adiciona apenas o necessário. Não vai quebrar seu projeto.',
      'ngadd.how.once': '✅ <strong>Execute uma vez:</strong> Se executar novamente, ele pula o que já está configurado.',
      'ngadd.configures.title': 'O que é Configurado',
      'ngadd.configures.intro': 'O schematic automaticamente:',
      'ngadd.configures.item1': '✅ Adiciona <code>provideToastly()</code> na configuração do app',
      'ngadd.configures.item2': '✅ Adiciona <code>&lt;toastly-container /&gt;</code> no AppComponent',
      'ngadd.configures.item3': '✅ Detecta se seu projeto usa standalone components ou NgModule',
      'ngadd.configures.item4': '✅ Evita duplicar código se já estiver configurado',
      'ngadd.configures.item5': '✅ Mostra mensagens claras sobre o que foi alterado',
      'ngadd.notdo.title': 'O que NÃO Faz',
      'ngadd.notdo.intro': 'Por design, o schematic não:',
      'ngadd.notdo.item1': '❌ Define tema específico (light/dark)',
      'ngadd.notdo.item2': '❌ Configura idioma ou i18n',
      'ngadd.notdo.item3': '❌ Modifica estilos ou layout do seu app',
      'ngadd.notdo.item4': '❌ Adiciona dependências desnecessárias',
      'ngadd.notdo.why': '<strong>Por quê?</strong> Essas decisões pertencem à sua aplicação, não à biblioteca. ng-toastly respeita seu código e adiciona apenas a configuração mínima necessária.',
      'ngadd.why.title': 'Por que Usar um Schematic?',
      'ngadd.why.item1': '<strong>Reduz tempo de setup</strong> — Sem edição manual de arquivos',
      'ngadd.why.item2': '<strong>Previne erros</strong> — Configuração correta sempre',
      'ngadd.why.item3': '<strong>Melhora DX</strong> — Experiência de desenvolvedor melhor desde o início',
      'ngadd.why.item4': '<strong>Mantém código limpo</strong> — Adiciona apenas o necessário',
      'ngadd.safe.title': 'Segurança & Boas Práticas',
      'ngadd.safe.item1': '🔒 <strong>Idempotente:</strong> Executar duas vezes não duplica nada',
      'ngadd.safe.item2': '🔍 <strong>Respeita estrutura:</strong> Funciona com seu setup existente',
      'ngadd.safe.item3': '📝 <strong>Feedback claro:</strong> Mensagens no terminal explicam o que mudou',
      'ngadd.options.title': 'Opções Disponíveis',
      'ngadd.options.intro': 'Você pode personalizar o schematic com opções:',
      'ngadd.options.position': 'Define posição padrão do toast',
      'ngadd.options.skipContainer': 'Pula a adição do container',
